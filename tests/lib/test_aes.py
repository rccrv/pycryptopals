...
def test_decrypt_aes_ecb_block():
...
def test_encrypt_aes_ecb_block():
...
def test_decrypt_aes_ecb():
    bi = Data(
        b"\x9d\xa8\xf5\x85\x07\xd3\x8a\x88\xf5\xdb\xfe\x94\x18\xf6\xa1\x13\xf6\x12\x77\xea\x63\xd6\x8a\x1f\x3f\xb6\xef\x2a\x02\x60\xc4\x78"
    )
    ki = Data(b"ABCDEFGHIJKLMNOP")
